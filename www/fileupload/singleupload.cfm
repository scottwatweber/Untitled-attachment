...
function popitup(filename) {
    ...
    newwindow1=window.open('showAttachment.cfm?file='+filename,'subWindow', 'resizable=1,height=500,width=500');
 	return false;
}
	...
	<div>
         ...
         <tbody>
			 ...
			 <tr  onmouseover="this.style.background = '##FFFFFF';"  <cfif filesLinked.currentrow mod 2 eq 0>bgcolor="##FFFFFF"<cfelse>bgcolor="##f7f7f7"</cfif>>
                 ...
                 <td width="40px" align="center" valign="middle" nowrap="nowrap" class="normal-td"><a href="javascript:void(0);" onclick="DeleteFile('#fileslinked.attachment_Id#','#filesLinked.attachmentFileName#')" title="Delete"><img src="../webroot/images/icon_delete.png" alt="delete" /></a></td>
             </tr>
         	</cfloop>
         </tbody>
     	</table>
