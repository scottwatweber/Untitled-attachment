<cfoutput> 
 ...
 <script type="text/javascript" src="https://maps.google.com/maps/api/js?sensor=false&v=3"></script> 
		...
		<script src="javascripts/Validation.js" language="javascript" type="text/javascript"></script>
		...
		<cfinvoke component="#variables.objloadGateway#" method="getLoadSystemSetupOptions" returnvariable="request.qSystemSetupOptions1" />
			...
			<cfif StructKeyExists(url,"event")>
				...
				<cfelseif url.event eq "load">
					<cfset variables.ClassName = "AllLoadTableWrap" >
				</cfif>
			</cfif>
			...
			<div class="container">
				...
				<div style="width:5%; float:left; margin-top:2%;"> Version 2.74 20140930 </div>
									...
									<td><cfif isdefined('session.passport.isLoggedIn') and session.passport.isLoggedIn>
											<table class="navigation" style="border-collapse:collapse; border:none;" border="0" cellpadding="0" cellspacing="0">
												<tr>
													...
													<td><a href="index.cfm?event=agent&sortorder=asc&sortby=Name&#Session.URLToken#" <cfif event is 'agent' or event is 'addagent:process' or event is 'addagent'> class="active" </cfif>>Agent</a></td>
													...
													<td><a href="index.cfm?event=carrier&#Session.URLToken#" <cfif event is 'carrier' or event is 'addcarrier:process' or event is 'addcarrier' or event is 'equipment' or event is 'equipment:process' or event is 'addequipment'> class="active" </cfif>>Carriers</a></td>
