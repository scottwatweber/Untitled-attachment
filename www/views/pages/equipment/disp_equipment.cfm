...
<div class="addbutton"><a href="index.cfm?event=#variables.addEquipmentType#&#session.URLToken#">Add New</a></div></div>  
...
<!---     	<th align="center" width="10%" valign="middle" class="head-bg"  onclick="document.location.href='index.cfm?event=equipment&sortorder=#sortorder#&sortby=EquipmentName&#session.URLToken#'">Post Everywhere</th>	 --->
	...
	<!---     <th align="center" valign="middle" class="head-bg"  onclick="document.location.href='index.cfm?event=equipment&sortorder=#sortorder#&sortby=EquipmentW&#session.URLToken#'">Width</th>		 --->		
    	<th align="center" valign="middle" class="head-bg" onclick="document.location.href='index.cfm?event=equipment&sortorder=#sortorder#&sortby=IsActive&#session.URLToken#'">Status</th>
		<th align="center" valign="middle" class="head-bg" style="width:60px" onclick="document.location.href='index.cfm?event=equipment&sortorder=#sortorder#&sortby=ITSCode&#session.URLToken#'">ITS Code</th>
    	<th align="center" valign="middle" class="head-bg" onclick="document.location.href='index.cfm?event=equipment&sortorder=#sortorder#&sortby=TranscoreCode&#session.URLToken#'"  style="white-space:nowrap; padding:0px 5px; width:60px">Transcore360 Code</th>
    	<th align="center" valign="middle" class="head-bg" onclick="document.location.href='index.cfm?event=equipment&sortorder=#sortorder#&sortby=PosteverywhereCode&#session.URLToken#'" style="white-space:nowrap; padding:0px 5px;">Posteverywhere Code</th>
    	<th align="center" valign="middle" class="head-bg2" onclick="document.location.href='index.cfm?event=equipment&sortorder=#sortorder#&sortby=LoadBoardCode&#session.URLToken#'" style="white-space:nowrap; padding:0px 5px;">123LoadBoard Code</th>
