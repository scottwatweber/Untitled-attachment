...
js.src = "http://maps.google.com/maps/api/js?sensor=false";
...
var sales=frm.salesperson.value;
if(sales=="")
{
	 alert('Please enter a Sales Representative Id');
	 frm.salesperson.focus();
	 return false;	
}
	
var dispatcherid=frm.Dispatcher.value;
if(dispatcherid=="")
{
	 alert('Please enter a Dispatcher Id');
	 frm.Dispatcher.focus();
	 return false;
}
var load=frm.LoadPotential.value;
if(load=='')
{
	alert('Please enter the Load Potential');
	frm.LoadPotential.focus();
	return false;
}
...
var opp=frm.BestOpp.value;
if(opp=='')
{
	alert('Please enter the BestOpp');
	frm.BestOpp.focus();
	return false;
}	
...
function calculateTotalRates(dsn){
	//#request.qCustomer.customerName#
	updateTotalRates(dsn);
}
