...
function ConfirmMessage(index,stopno){
        ...
        <div class="form-con">
          <fieldset>
		   ...
		   <input type="hidden" name="shipperUpAdd#stopNumber#" id="shipperUpAdd#stopNumber#" value=""> 
            ...
            <textarea class="addressChange" rows="" name="shipperlocation#stopNumber#" id="shipperlocation#stopNumber#" cols=""   onkeydown="ChkUpdteShiprAddress(this.value,'Shipper',#stopNumber#);" data-role="#stopNumber#" onkeyup ="showChangeAlert('shipper',#stopNumber#);" tabindex="#evaluate(currentTab+1)#">#shiplocation#</textarea>
            <div class="clear"></div>
            <label>City</label>
            <input class="addressChange" name="shippercity#stopNumber#" id="shippercity#stopNumber#" value="#shipcity#" type="text" data-role="#stopNumber#" onkeyup ="showChangeAlert('shipper',#stopNumber#);"  onkeydown="ChkUpdteShiprCity(this.value,'Shipper',#stopNumber#);" <cfif shipzipcode eq ''>tabindex="#evaluate(currentTab+1)#"</cfif>/>
            <div class="clear"></div>
            <label>State</label>
            ...
            <div class="clear"></div>
            <label>Zip</label>
            <input class="addressChange" name="shipperZipcode#stopNumber#" id="shipperZipcode#stopNumber#" value="#shipzipcode#" type="text" data-role="#stopNumber#" onkeyup ="showChangeAlert('shipper',#stopNumber#);" <cfif shipzipcode neq ''>tabindex="#evaluate(currentTab+1)#"</cfif>/>
            <div class="clear"></div>
            <label>Contact</label>
  ...
  <input type="hidden" name="consigneeUpAdd#stopNumber#" id="consigneeUpAdd#stopNumber#" value="">
            ...
            <textarea class="addressChange" rows="" name="consigneelocation#stopNumber#" id="consigneelocation#stopNumber#" cols="" 	onkeydown="ChkUpdteShiprAddress(this.value,'consignee',#stopNumber#);"  data-role="#stopNumber#" onkeyup ="showChangeAlert('consignee',#stopNumber#);" tabindex="#evaluate(currentTab+1)#">#Consigneelocation#</textarea>
            <div class="clear"></div>
            <label>City</label>
            <input class="addressChange" name="consigneecity#stopNumber#" id="consigneecity#stopNumber#" value="#Consigneecity#" type="text"  data-role="#stopNumber#" onkeydown="ChkUpdteShiprCity(this.value,'consignee',#stopNumber#);" onkeyup ="showChangeAlert('consignee',#stopNumber#);" <cfif Consigneezipcode eq ''>tabindex="#evaluate(currentTab+1)#"</cfif>/>
            <div class="clear"></div>
            <label>State</label>
          ...
          <tbody>
			...
			<cfloop query="request.qItems">
                <tr <cfif request.qItems.currentRow mod 2 eq 0>bgcolor="##FFFFFF"<cfelse>  bgcolor="##f7f7f7"</cfif> >
                  ...
                  <td class="normaltdC" valign="middle" align="left"><input name="description#request.qItems.currentRow##stopNumber#" id="description#request.qItems.currentRow##stopNumber#" class="t-textbox" value="#request.qItems.description#" type="text" tabindex="#evaluate(currentTab+1)#" /></td>
				  ...
				  <td class="normaltdC" valign="middle" align="left"><input name="CustomerRate#request.qItems.currentRow##stopNumber#" id="CustomerRate#request.qItems.currentRow##stopNumber#" onChange="CalculateTotal();formatDollar(this.value, this.id);" class="q-textbox CustomerRate" value="#DollarFormat(variables.CustomerRate)#"  type="text" tabindex="#evaluate(currentTab+1)#"/></td>
                  <td class="normaltd2C" valign="middle" align="left"><input name="CarrierRate#request.qItems.currentRow##stopNumber#" id="CarrierRate#request.qItems.currentRow##stopNumber#" onChange="CalculateTotal();formatDollar(this.value, this.id);" class="q-textbox CarrierRate" value="#DollarFormat(variables.CarrierRate)#"  type="text" tabindex="#evaluate(currentTab+1)#" /></td>
              ...
              <cfif request.qItems.recordcount lt 7>
                ...
                <cfloop from ="#remainCol#" to="7" index="rowNum">
                  <tr <cfif rowNum mod 2 eq 0>bgcolor="##FFFFFF"<cfelse>  bgcolor="##f7f7f7"</cfif> >
                    ...
                    <td class="normaltdC" valign="middle" align="left"><select style="60px;" name="unit#rowNum##stopNumber#" id="unit#rowNum##stopNumber#" class="unit t-select typeSelect#stopNumber#" onchange="changeQuantityWithtype(this,'#stopNumber#');checkForFee(this.value,'#rowNum#','#stopNumber#','#application.dsn#')" tabindex="#evaluate(currentTab+1)#">
                        <option value=""></option>
                        <cfloop query="request.qUnits">
              ...
              <cfloop from ="1" to="7" index="rowNum">
                <tr <cfif rowNum mod 2 eq 0>bgcolor="##FFFFFF"<cfelse>  bgcolor="##f7f7f7"</cfif> >
                  ...
                  <td class="lft-bg2" valign="middle" align="center"><input name="isFee#rowNum##stopNumber#" id="isFee#rowNum##stopNumber#" class="isFee check" type="checkbox" tabindex="#evaluate(currentTab+1)#"/></td>
                  <td class="normaltdC" valign="middle" align="left"><input name="qty#rowNum##stopNumber#" id="qty#rowNum##stopNumber#" onChange="CalculateTotal()" value="1" class="qty q-textbox" type="text"  tabindex="#evaluate(currentTab+1)#"/></td>
                  <td class="normaltdC" valign="middle" align="left"><select name="unit#rowNum##stopNumber#" id="unit#rowNum##stopNumber#" class="unit t-select typeSelect#stopNumber#" onchange="changeQuantityWithtype(this,'#stopNumber#');checkForFee(this.value,'#rowNum#','#stopNumber#','#application.dsn#')" tabindex="#evaluate(currentTab+1)#">
                      <option value=""></option>
                      <cfloop query="request.qUnits">
                        <option value="#request.qUnits.unitID#">#request.qUnits.unitName#<cfif trim(request.qUnits.unitCode) neq ''>(#request.qUnits.unitCode#)</cfif></option>
                      </cfloop>
