          ...
          <tbody>
			...
			<cfloop query="request.qItems">
                <tr <cfif request.qItems.currentRow mod 2 eq 0>bgcolor="##FFFFFF"<cfelse>  bgcolor="##f7f7f7"</cfif> >
                  ...
                  <td class="normaltdC" valign="middle" align="left"><input name="description#request.qItems.currentRow##stopNumber#" id="description#request.qItems.currentRow##stopNumber#" class="t-textbox" value="#request.qItems.description#" type="text" tabindex="#evaluate(currentTab++)#" <cfif not request.qSystemSetupOptions.commodityWeight> style="width:220px;" </cfif>/></td>
				   <cfif request.qSystemSetupOptions.commodityWeight>
				  ...
				  <td class="normaltdC" valign="middle" align="left"><input name="CustomerRate#request.qItems.currentRow##stopNumber#" id="CustomerRate#request.qItems.currentRow##stopNumber#" onChange="CalculateTotal();formatDollar(this.value, this.id);" class="q-textbox CustomerRate" value="#DollarFormat(variables.CustomerRate)#"  type="text" tabindex="#evaluate(currentTab++)#"/></td>
                  <td class="normaltd2C" valign="middle" align="left"><input name="CarrierRate#request.qItems.currentRow##stopNumber#" id="CarrierRate#request.qItems.currentRow##stopNumber#" onChange="CalculateTotal();formatDollar(this.value, this.id);" class="q-textbox CarrierRate" value="#DollarFormat(variables.CarrierRate)#"  type="text" tabindex="#evaluate(currentTab++)#" /></td>
              ...
              <cfloop from ="1" to="7" index="rowNum">
                <tr <cfif rowNum mod 2 eq 0>bgcolor="##FFFFFF"<cfelse>  bgcolor="##f7f7f7"</cfif> >
                  ...
                  <td class="lft-bg2" valign="middle" align="center"><input name="isFee#rowNum##stopNumber#" id="isFee#rowNum##stopNumber#" class="isFee check" type="checkbox" tabindex="#evaluate(currentTab++)#"/></td>
                  <td class="normaltdC" valign="middle" align="left"><input name="qty#rowNum##stopNumber#" id="qty#rowNum##stopNumber#" onChange="CalculateTotal()" value="1" class="qty q-textbox" type="text"  tabindex="#evaluate(currentTab++)#"/></td>
                  <td class="normaltdC" valign="middle" align="left"><select name="unit#rowNum##stopNumber#" id="unit#rowNum##stopNumber#" class="unit t-select typeSelect#stopNumber#" onchange="changeQuantityWithtype(this,'#stopNumber#');checkForFee(this.value,'#rowNum#','#stopNumber#','#application.dsn#')" tabindex="#evaluate(currentTab++)#">
                      <option value=""></option>
                      <cfloop query="request.qUnits">
                        <option value="#request.qUnits.unitID#">#request.qUnits.unitName#<cfif trim(request.qUnits.unitCode) neq ''>(#request.qUnits.unitCode#)</cfif></option>
                      </cfloop>
                    </select></td>
                  <td class="normaltdC" valign="middle" align="left"><input name="description#rowNum##stopNumber#" id="description#rowNum##stopNumber#" class="t-textbox" type="text" tabindex="#evaluate(currentTab++)#" <cfif not request.qSystemSetupOptions.commodityWeight> style="width:220px;" </cfif> /></td>
				   <cfif request.qSystemSetupOptions.commodityWeight>
						<td class="normaltdC" valign="middle" align="left"><input name="weight#rowNum##stopNumber#" class="wt-textbox" type="text" tabindex="#evaluate(currentTab++)#"/></td>
					</cfif>	
