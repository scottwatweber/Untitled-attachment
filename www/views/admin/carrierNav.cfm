...
<div class="below-navleft">
	<ul>
		<li>
			<a href="index.cfm?event=carrier&#session.URLToken#" <cfif event is 'carrier' or event is 'addcarrier:process' or event is 'addcarrier'> class="active" </cfif>>
		...
		<li>
			<a href="index.cfm?event=equipment&#session.URLToken#" <cfif event is 'equipment' or event is 'addequipment:process' or event is 'addequipment' or event is 'addDriverEquipment:process' or event is 'addDriverEquipment'> class="active" </cfif>>
				Equipment
			</a>
		</li>
